...
//
//------------------------------------------------------------------
LunarLander.objects.ParticleSystem.createEffectExplosion = function(spec) {
    'use strict';
    let effect = { };
    ...
    effect.update = function() {
        for (let particle = 0; particle < spec.howMany; particle += 1) {
            ...
            LunarLander.objects.ParticleSystem.createParticle({
    ...
    return LunarLander.objects.ParticleSystem.addEffect(effect);
};
